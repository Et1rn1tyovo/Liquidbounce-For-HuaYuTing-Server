## Warning
If you skid this client,you should follow the open source protocol
## 警告
如果你打滑了此客户端，请自觉遵守开源协议

# LiquidBounce
A free Minecraft 1.8.9 Hack Client forked from LiquidBounce
...
You are allowed to
- use
- share[mcmod.info](..%2FLiquidBounce-legacy%2Fsrc%2Fmain%2Fresources%2Fmcmod.info)
- modify
