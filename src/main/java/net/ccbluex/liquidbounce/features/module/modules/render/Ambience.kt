...
object Ambience : Module("Ambience", ModuleCategory.RENDER) {
    ...
    val worldColorValue by BoolValue("WorldColor", false)
    val worldColorRValue by IntegerValue("WorldRed", 255, 0..255) { worldColorValue }
    val worldColorGValue by IntegerValue("WorldGreen", 255, 0..255) { worldColorValue }
    val worldColorBValue by IntegerValue("WorldBlue", 255, 0..255) { worldColorValue }
