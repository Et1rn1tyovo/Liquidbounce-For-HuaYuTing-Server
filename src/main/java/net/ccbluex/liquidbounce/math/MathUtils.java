package net.ccbluex.liquidbounce.math;
...
public class MathUtils {
    ...
    public static final double easeOutQuart(double x) {
        double var10000 = (double)1;
        double var2 = (double)1 - x;
        byte var4 = 4;
        return var10000 - Math.pow(var2, (double)var4);
    }
    ...
    public static double[] yawPos(double value) {
        return yawPos(Minecraft.getMinecraft().thePlayer.rotationYaw * 0.017453292F, value);
    }
