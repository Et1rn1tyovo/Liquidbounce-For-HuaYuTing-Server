...
object Fonts : MinecraftInstance() {
    ...
    @FontDetails(fontName = "Minecraft Font")
    val minecraftFont2: FontRenderer = mc.standardGalacticFontRenderer
    ...
    lateinit var fontTahoma30: GameFontRenderer

    private val CUSTOM_FONT_RENDERERS = HashMap<FontInfo, FontRenderer>()
    var fontTahomaSmall: TTFFontRenderer? = null
    ...
    fun loadFonts() {
        ...
        fontTahoma = GameFontRenderer(getCustomFont("TahomaBold.ttf", 35))
        fontTahoma30 = GameFontRenderer(getCustomFont("TahomaBold.ttf", 30))
        fontTahomaSmall = TTFFontRenderer(getCustomFont("Tahoma.ttf", 11))

        fontBold35 = GameFontRenderer(getFont("Roboto-Bold.ttf", 35))
        fontBold40 = GameFontRenderer(getFont("Roboto-Bold.ttf", 40))
    ...
    private fun getCustomFont(fontName: String,size: Int): Font {
        ...
        try {
            val `is` =
                Minecraft.getMinecraft().resourceManager.getResource(ResourceLocation("liquidbounce/font/"+fontName)).inputStream
