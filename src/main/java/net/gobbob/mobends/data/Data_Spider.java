...
public class Data_Spider extends EntityData{
	...
	public void syncModelInfo(ModelBendsSpider argModel){
		...
		if(this.spiderForeLeg1 == null) this.spiderForeLeg1 = new ModelRendererBends(argModel); this.spiderForeLeg1.sync(argModel.spiderForeLeg1);
		if(this.spiderForeLeg2 == null) this.spiderForeLeg2 = new ModelRendererBends(argModel); this.spiderForeLeg2.sync(argModel.spiderForeLeg2);
		if(this.spiderForeLeg3 == null) this.spiderForeLeg3 = new ModelRendererBends(argModel); this.spiderForeLeg3.sync(argModel.spiderForeLeg3);
		if(this.spiderForeLeg4 == null) this.spiderForeLeg4 = new ModelRendererBends(argModel); this.spiderForeLeg4.sync(argModel.spiderForeLeg4);
		if(this.spiderForeLeg5 == null) this.spiderForeLeg5 = new ModelRendererBends(argModel); this.spiderForeLeg5.sync(argModel.spiderForeLeg5);
		if(this.spiderForeLeg6 == null) this.spiderForeLeg6 = new ModelRendererBends(argModel); this.spiderForeLeg6.sync(argModel.spiderForeLeg6);
		if(this.spiderForeLeg7 == null) this.spiderForeLeg7 = new ModelRendererBends(argModel); this.spiderForeLeg7.sync(argModel.spiderForeLeg7);
		if(this.spiderForeLeg8 == null) this.spiderForeLeg8 = new ModelRendererBends(argModel); this.spiderForeLeg8.sync(argModel.spiderForeLeg8);
